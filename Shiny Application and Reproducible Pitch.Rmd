...
The application is running on (https://jchagger.shinyapps.io/Course-Project-Shiny-Application-and-Reproducible-Pitch-master/)

ui.R, and Server.R Code in my github repository  (https://github.com/jchagger/Course-Project-Shiny-Application-and-Reproducible-Pitch-master)
